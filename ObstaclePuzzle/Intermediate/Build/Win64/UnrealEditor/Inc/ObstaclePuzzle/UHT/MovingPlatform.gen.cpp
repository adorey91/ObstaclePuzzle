...
#include "ObstaclePuzzle/MovingPlatform.h"
...
struct Z_Construct_UClass_AMovingPlatform_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MaxMovingDistance_MetaData[] = {
		{ "Category", "Moving" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
	};
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_MaxMovingDistance;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MaxMovingDistance = { "MaxMovingDistance", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMovingPlatform, MaxMovingDistance), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxMovingDistance_MetaData), NewProp_MaxMovingDistance_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMovingPlatform_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MaxMovingDistance,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_GithubRepos_ObstaclePuzzle_ObstaclePuzzle_Source_ObstaclePuzzle_MovingPlatform_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 4118609187U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GithubRepos_ObstaclePuzzle_ObstaclePuzzle_Source_ObstaclePuzzle_MovingPlatform_h_3758438752(TEXT("/Script/ObstaclePuzzle"),
	Z_CompiledInDeferFile_FID_GithubRepos_ObstaclePuzzle_ObstaclePuzzle_Source_ObstaclePuzzle_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GithubRepos_ObstaclePuzzle_ObstaclePuzzle_Source_ObstaclePuzzle_MovingPlatform_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
